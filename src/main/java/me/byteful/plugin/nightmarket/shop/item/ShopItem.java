...
public record ShopItem(String id, IconData icon, List<String> commands, Currency currency, double amount, double rarity, int purchaseLimit) {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(shopItem.amount, this.amount) == 0 && Double.compare(shopItem.rarity,
            ...
            this.commands, shopItem.commands) && Objects.equals(this.currency, shopItem.currency);
    }

    @Override
    public String toString() {
        return "ShopItem{" + "id='" + this.id + '\'' + ", icon=" + this.icon + ", command='" + this.commands + '\'' + ", currency=" + this.currency + ", amount=" + this.amount + ", rarity=" + this.rarity + ", isMultiplePurchase=" + this.purchaseLimit + '}';
    }
}
